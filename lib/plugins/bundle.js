  ...
  */
  function matchBundles(tagname, attribs, config, state) {
    ...
    _.forEach(bundleNames, function(bundleName) {
      ...
      var bundleVersion = '{{^static:' + bundleKey + '}}YOU_SPECIFIED_A_BUNDLE_THAT_ISNT_AVAILABLE_TO_THIS_PAGE{{/static:' + bundleKey + '}}{{#static:' + bundleKey + '}}{{static:' + bundleKey + '}}{{/static:' + bundleKey + '}}';
